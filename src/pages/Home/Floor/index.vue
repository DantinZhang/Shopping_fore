            ...
            <div class="title clearfix">
                ...
                <div class="fr">
                    <ul class="nav-tabs clearfix">
                        <li :class="{active: index===0}" v-for="(nav,index) in eachFloor.navList" :key="index">
            ...
            <div class="tab-content">
                <div class="tab-pane">
                    <div class="floor-1">
                        <div class="blockgary">
                            <ul class="jd-list">
                                <li v-for="(keyword,index) in eachFloor.keywords" :key="index">{{keyword}}</li>
                            </ul>
                            <img :src=eachFloor.imgUrl />
                        </div>
                        <div class="floorBanner">
                            <!-- 轮播图 -->
                            <Carousel :carousels="eachFloor.carouselList"></Carousel>
                        </div>
                        <div class="split">
...
<script>
import Carousel from '@/components/Carousel';  //引入轮播图
export default {
    name: 'Floor',
    props: ['eachFloor'],
    components: { Carousel },
